...
exports.estate_company = function(req, res) {
	res.render('front/estate_company', {
		layout: "layout",
		url: req.url
	});
};
...
exports.estate_detail = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		res.render('front/estate_detail', {
			layout: "layout",
			url: req.url,
			record: rows1
		});
...
exports.estate_broker = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		mysql.query(sql5, function(err1, rows5) {
			...
			var isFirstPage = page == 1;
			var isLastPage = ((page - 1) * limit + rows1.length) == total;
			res.render('front/estate_broker', {
				layout: "layout",
				url: req.url,
				record: rows1,
				page: page,
...
exports.financing_home = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		mysql.query(sql5, function(err1, rows5) {
			...
			var isFirstPage = page == 1;
			var isLastPage = ((page - 1) * limit + rows1.length) == total;
			res.render('front/financing_home', {
				layout: "layout",
				url: req.url,
				record: rows1,
				page: page,
...
exports.financing_introduce = function(req, res) {
	res.render('front/financing_introduce', {
		layout: "layout",
		url: req.url
	});
};
...
exports.financing_list = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		mysql.query(sql5, function(err1, rows5) {
			...
			var isFirstPage = page == 1;
			var isLastPage = ((page - 1) * limit + rows1.length) == total;
			res.render('front/financing_list', {
				layout: "layout",
				url: req.url,
				record: rows1,
				page: page,
...
exports.financing_detail = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		res.render('front/financing_detail', {
			layout: "layout",
			url: req.url,
			record: rows1
		});
...
exports.option_estate1 = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		mysql.query(sql5, function(err1, rows5) {
			...
			var isFirstPage = page == 1;
			var isLastPage = ((page - 1) * limit + rows1.length) == total;
			res.render('front/option_estate1', {
				layout: "layout",
				url: req.url,
				record: rows1,
				page: page,
...
exports.option_estate2 = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		res.render('front/option_estate2', {
			layout: "layout",
			url: req.url,
			record: rows1
		});
...
exports.option_estate3 = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		res.render('front/option_estate3', {
			layout: "layout",
			url: req.url,
			rows1: rows1
		});
...
exports.option_financing1 = function(req, res) {
	...
	mysql.query(sql1, function(err, rows1) {
		...
		mysql.query(sql5, function(err1, rows5) {
			...
			var isFirstPage = page == 1;
			var isLastPage = ((page - 1) * limit + rows1.length) == total;
			res.render('front/option_financing1', {
				layout: "layout",
				url: req.url,
				record: rows1,
				page: page,
...
exports.option_financing2 = function(req, res) {
	...
	res.render('front/option_financing2', {
		layout: "layout",
		url: req.url
	});
};
...
exports.House_getArea = function(req, res) {
